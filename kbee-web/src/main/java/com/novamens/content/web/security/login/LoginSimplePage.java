...
public class LoginSimplePage extends AbstractKbeeWebPage {
			
private static Logger logger = Logger.getLogger(LoginSimplePage.class.getName());
	...
	public  LoginSimplePage() {
		 this(null);
	}
	
	
	public LoginSimplePage(PageParameters _parameters) {
				super();
	...
	public void onInitialize() {
		...
		area.add(new LoginPanelV6("login", this.parameters));
		...
		if (iw!=null) {
			...
			logger.error("service.getTodayLoginImageWrapper() is null");
		}
		area.add(bck);
