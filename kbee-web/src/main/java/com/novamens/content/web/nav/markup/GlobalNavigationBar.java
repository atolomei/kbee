...
public class GlobalNavigationBar<T> extends NavigationPanel<T>  {
	...
	public class NotificationsFragment extends Fragment {
		public NotificationsFragment (String id) {
			super(id, "notifications-fragment", GlobalNavigationBar.this);
			...
			Link<Void> link = new Link<Void>("notifications-link") {
				...
				public boolean isVisible() {
					return ServiceLocator.getService(BrandingService.class).isNotificationEnabled() && isAlerts;
				}
			};
	...
	public class HelpFragment extends Fragment {
		public HelpFragment(String id) {
			super(id, "help-fragment", GlobalNavigationBar.this);
	...
	public class BrandFactoryFragment extends Fragment {
		public BrandFactoryFragment(String id) {
			super(id, "brand-factory-fragment", GlobalNavigationBar.this);
	...
	public class BrandIDocFragment extends Fragment {
		public BrandIDocFragment(String id) {
			super(id, "brand-idoc-fragment", GlobalNavigationBar.this);
	...
	public class MobileBrandIDocFragment extends Fragment {
		public MobileBrandIDocFragment(String id) {
			super(id, "mobile-brand-idoc-fragment", GlobalNavigationBar.this);
	 ...
	 * 
	 */
	public GlobalNavigationBar() {
		this("navigation");
	}
	
	public GlobalNavigationBar(String id) {
		this(id, null, false);
	}
	
	public GlobalNavigationBar(String id, String returnLabel) {
			this(id, returnLabel, false);
	}
	
	public GlobalNavigationBar(String id, String returnLabel, boolean isSearch) {
		super(id);
	...
	protected void onSearch(AjaxRequestTarget target, Suggestion suggestion)  	{}
 	...
 	protected Component newNavigator(Searcher searcher, long index)  {
		return new NavigatorPanel<T>("navigator", searcher, (int)index) {
			public void onNavigate(T object) {
				GlobalNavigationBar.this.onNavigate(object);
			}
		};
	}
		...
		if (isSuggester()) {
			return new SuggesterSearchPanel("search", str) {
				...
				public void onSearch(AjaxRequestTarget target, String text) {
					GlobalNavigationBar.this.onSearch(target, text);
				}
				@Override
				public void onSearch(AjaxRequestTarget target, Suggestion suggestion) {
					GlobalNavigationBar.this.onSearch(target, suggestion);
				}
				@Override
				protected List<Suggestion> getSuggestions(String pattern) {
					return GlobalNavigationBar.this.getSuggestions(pattern); 
				}
			};
		}
		else {
	...
	protected void addComponents() {
		...
		navbar.add(newIDocBrandPanel());  				// KBEE
		navbar.add(newMobileIDocBrandPanel());  		// KBEE
		
		navbar.add(newFactoryBrandPanel()); 	// kbee/iDOC: Factory		
		navbar.add(newSettingsPanel());
		//navbar.add(newNotificationsPanel());
		
		navbar.add(new InvisiblePanel("notifications"));
	...
	protected void addListeners() {
		...
		add(new WicketEventListener<NotificationDelete>() {
			...
			public void onEvent(NotificationDelete event) {
				event.getRequestTarget().add(GlobalNavigationBar.this);
			}
		});
