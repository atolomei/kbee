...
public class AALoginPage2 extends AbstractKbeeWebPage {

	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(AALoginPage.class.getName());

	private static final ResourceReference CSS_AA_LOGIN = new CssResourceReference(AALoginPage.class, "aa.css");
	...
	public AALoginPage2(PageParameters _parameters) {
		super();
