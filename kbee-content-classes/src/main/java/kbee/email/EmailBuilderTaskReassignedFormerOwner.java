...
public class EmailBuilderTaskReassignedFormerOwner extends EmailBuilderWorkflowTask implements EmailBuilder { 

	private User reasignedBy;
	private Activity activity;
	
	public EmailBuilderTaskReassignedFormerOwner() {
		super();
	}

	public EmailBuilderTaskReassignedFormerOwner(Activity activity, User reasignedBy) {
		setActivity(activity);
		setReasignedBy(reasignedBy);
	}
	...
	public User getReasignedBy() {
		return reasignedBy;
	}

	public void setReasignedBy(User reasignedBy) {
		this.reasignedBy = reasignedBy;
	}

	@Override
	public String getKey() {
	   return EmailTemplate.TASK_REASSIGN_FORMER_OWNER;
	}
	...
	public TemplateModel getTemplateModel() {
		...
		model.setModel("user", getReasignedBy());
