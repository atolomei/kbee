...
public class EmailBuilderWorkflowDueDateTask extends EmailBuilderWorkflowTask implements EmailBuilder {

	private static Logger logger = Logger.getLogger(EmailBuilderWorkflowDueDateTask.class.getName());

	private Activity activity;
	
	public EmailBuilderWorkflowDueDateTask() {
	}
	
	public EmailBuilderWorkflowDueDateTask(Activity activity) {
		super();
	...
	public String getKey() {
		return EmailTemplate.TASK_DUE_DATE_NOTIFICATION;
	}
