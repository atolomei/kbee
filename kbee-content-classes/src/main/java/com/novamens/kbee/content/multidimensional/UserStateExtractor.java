...
public class UserStateExtractor implements Extractor {

	public Object extract(Object object) throws IndexerException  {
		List<String> members = new ArrayList<String>();
		if (object instanceof DataSetMember) {
			members.add(String.valueOf(((DataSetMember)object).getState().getId()));
		}
		...
		if (user==null) 
			return members;
		members.clear();
		members.add(String.valueOf(((KbeeUser)user).getState().getId()));
		return members;
	}
}
