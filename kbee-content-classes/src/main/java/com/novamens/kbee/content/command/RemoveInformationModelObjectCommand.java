...
public class RemoveInformationModelObjectCommand extends AsyncCommand implements RemoveCommand {

	private ModelObject modelobject;
	
	public RemoveInformationModelObjectCommand(ModelObject modelobject) {
	...
	protected void executeAsync() {
		...
		try  {
			...
			if (modelobject==null)
				throw new KbeeRuntimeException("modelobject can not be null");
