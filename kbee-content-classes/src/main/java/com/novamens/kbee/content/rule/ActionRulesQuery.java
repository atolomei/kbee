...
public class ActionRulesQuery extends HibernateQuery {
	private static final long serialVersionUID = 1L;
	
	public ActionRulesQuery() {
	}
	...
	public String getStatement() {
		...
		statement.append("from " + KbeeIqlActionRule.class.getSimpleName() + " R where R.domain.id=" + String.valueOf(domain.getId()) +"  " + (txt!=null?txt:""));
		String sizeQuery = "select count (*) FROM " + KbeeIqlActionRule.class.getSimpleName() + " R WHERE R.domain.id=" + domain.getId().toString() +" " + (txt!=null?txt:"");
