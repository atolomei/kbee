...
alter table kb_comment add column creationdate timestamp with time zone default now();
...
alter table kb_comment add column isfirstlevel boolean default true;
alter table kb_comment add column parent_comment bigint;
alter table kb_comment add constraint comment_responses_fk foreign key(parent_comment) references kb_comment(content_id) on delete cascade;
alter table kb_comment add column site_id bigint;
