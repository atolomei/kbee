// ========================================================================
// $Id: LazyList.java,v 1.3 2007/03/08 00:46:47 alexis Exp $
...
public class LazyList {
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static Object add(final Object list, final int index,
			final Object item) {
		if (list == null) {
	 ...
	 */
	@Deprecated
	protected Object add(Object list, final Collection collection) {
	...
	public static String toString(final Object list) {
		...
		return "[" + list + "]"; //$NON-NLS-1$//$NON-NLS-2$
	}
