...
@Deprecated
public class DealRoomUpdateHandler extends AbstractRequestHandler {
			
	private static kbee.util.logging.Logger logger = kbee.util.logging.Logger.getLogger(DealRoomUpdateHandler.class.getName());
