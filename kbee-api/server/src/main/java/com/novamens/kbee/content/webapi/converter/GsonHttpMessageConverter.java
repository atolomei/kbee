...
package com.novamens.kbee.content.webapi.converter;
...
import com.novamens.kbee.content.webapi.type.gson.HibernateProxyTypeAdapter;
import com.novamens.kbee.content.webapi.type.gson.MemberClassificationTypeAdapter;
import com.novamens.kbee.content.webapi.type.gson.ObjectTypeAdapterFactory;
import com.novamens.kbee.content.webapi.type.gson.OffsetDateTimeAdapter;
import com.novamens.kbee.content.webapi.type.gson.PrincipalTypeAdapter;
...
public class GsonHttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
    ...
    public GsonHttpMessageConverter() {
        ...
        //b.registerTypeAdapterFactory(ObjectTypeAdapter.FACTORY);
...
//			int intValueOfChar;
//			String targetString = "";
//			while ((intValueOfChar = json.read()) != -1) {
//				targetString += (char) intValueOfChar;
//			}
//			json.close();
//			json = new InputStreamReader(inputMessage.getBody(), getCharset(inputMessage.getHeaders()));
//			// System.out.println("JSON: "+targetString);
            Object object = this.gson.fromJson(json, token.getType());
            // // System.out.println(this.gson.toJson(object));
            return object;
    ...
    protected void writeInternal(Object o, Type type, HttpOutputMessage outputMessage)
        ...
        if (TypeToken.get(type).getRawType().isInterface() && !type.getTypeName().contains("java.util.List"))
            type = o.getClass();

        GsonBuilder b = new GsonBuilder();
        b.registerTypeAdapterFactory(HibernateProxyTypeAdapter.FACTORY);
        b.registerTypeAdapterFactory(PrincipalTypeAdapter.FACTORY);
        b.registerTypeAdapterFactory(new ObjectTypeAdapterFactory(type));
        b.registerTypeAdapterFactory(OffsetDateTimeAdapter.FACTORY);
        b.registerTypeAdapterFactory(MemberClassificationTypeAdapter.FACTORY);
        Gson gson = b.create();
