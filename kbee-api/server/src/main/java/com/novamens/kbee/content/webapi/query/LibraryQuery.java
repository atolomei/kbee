...
public class LibraryQuery extends SolrParametersQuery {
	private static final long serialVersionUID = 1L;
	

	public LibraryQuery(Index index, Library library, User user, boolean facets) {
		super(index);
		...
		getParameters().put("state", ENABLED);
