 ...
 * @author Luke Taylor
 */
public class KbeeWebAuthenticationDetails extends WebAuthenticationDetails {
	 ...
	 */
	public KbeeWebAuthenticationDetails(HttpServletRequest request) {
		super(request);
...
//	 */
//	private KbeeWebAuthenticationDetails(final String remoteAddress, final String sessionId) {
...
//		if (obj instanceof KbeeWebAuthenticationDetails) {
//			KbeeWebAuthenticationDetails rhs = (KbeeWebAuthenticationDetails) obj;
//
