...
public class SourcesQuery extends HibernateQuery {
	...
	public String getStatement() {
		...
		statement.append("from KbeeSource R where R.domain.id= '" + domainQueryValue +"' " + (txt!=null?txt:""));

		String sizeQuery = "select count (*) FROM KbeeSource R WHERE R.domain.id= '" + domainQueryValue +"'" + (txt!=null?txt:"");
