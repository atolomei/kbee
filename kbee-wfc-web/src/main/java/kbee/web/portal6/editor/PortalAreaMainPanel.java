...
public class PortalAreaMainPanel extends PortalPanel<Area> {
	...
	public PortalAreaMainPanel(String id, IModel<Area> model) {
		super(id, model);
	...
	public void onInitialize() {
		...
		add(title);
		AjaxLink<Area> close = new AjaxLink<Area>("close", PortalAreaMainPanel.this.getModel()) {
			private static final long serialVersionUID = 1L;
			@Override
			public void onClick(AjaxRequestTarget target) {
				fireScanAll (new PortalCloseEditAjaxEvent<Area>(target, PortalAreaMainPanel.this.getModel()));
			}
		};
		add(close);		
		    ...
		    tabs.add(new AbstractTab(new StringResourceModel("control", this, null)) {
		        ...
		        public Panel getPanel(String panelId) {
		        	return new PortalAreaEditor(panelId, getModel());    		
		        }
		    });
		    ...
		    tabs.add(new AbstractTab(new StringResourceModel("css", this, null)) {
		        ...
		        @Override
		        public Panel getPanel(String panelId) {
		        	return new PortalCssEditor<Area>(panelId, getModel());    		
		        }
		    });
