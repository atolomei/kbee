...
public class PortalPageEditorPage extends ConsoleObjectPage<Page> {
	...
	public PortalPageEditorPage() {
	}
	
	public PortalPageEditorPage(PageParameters parameters) {
	...
	public PortalPageEditorPage(IModel<Page> model) {
		super(model);
	...
	public void onInitialize()  {
		...
		add(new PortalPageEditorMainPanel("panel", getModel()));
