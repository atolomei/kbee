...
public class ClassifiersDropdownBC extends DropDownMenuBC<Void> {
			
	private static final long serialVersionUID = 1L;

	private static kbee.util.logging.Logger logger = kbee.util.logging.Logger.getLogger(ClassifiersDropdownBC.class.getName());
	
	public ClassifiersDropdownBC() {
