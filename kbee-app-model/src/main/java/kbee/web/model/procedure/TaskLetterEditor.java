...
public class TaskLetterEditor extends ObjectEditor<Task> {
	
	private static final long serialVersionUID = 1L;

	private static kbee.util.logging.Logger logger = kbee.util.logging.Logger.getLogger(TaskLetterEditor.class.getName());
	...
	public TaskLetterEditor(String id, IModel<Task> model) {
		super(id, model);
