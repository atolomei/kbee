...
public class EnabledRolesEditor extends RelationEditor<NotificationRule, Role> {
	private static final long serialVersionUID = 1L;
				
	static Logger logger = LogManager.getLogger(EnabledRolesEditor.class.getName());

	public EnabledRolesEditor() {
		super("enabledRoles");
	}
	...
	protected Property<?> getKey() {
		return new Property<Role>() {
			...
			public List<Role> getChoices() {
				return EnabledRolesEditor.this.getRoles();
			}
		};
	}
	
//	protected String getStringValue(Role value) {
